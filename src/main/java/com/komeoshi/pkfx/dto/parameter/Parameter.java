...
public class Parameter {
    ...
    public static Parameter getParameterSim(){
        ...
        parameter1.setParamA$01(new ParameterA$CurrentAtr(5.0 / 1000));
        parameter1.setParamA$02(new ParameterA$CurrentTr(5.0 / 1000));
        parameter1.setParamA$03(new ParameterA$Past2Tr(5.0 / 1000));
        parameter1.setParamA$04(new ParameterA$Past3Atr(5.0 / 1000));
        parameter1.setParamA$05(new ParameterA$Past4Atr(5.0 / 1000));

        parameter1.setParamB$01(new ParameterB$Adx(11000.0 / 1000));
        parameter1.setParamB$02(new ParameterB$Past2Rsi(37000.0 / 1000));
        parameter1.setParamB$03(new ParameterB$Rsi(84000.0 / 1000));
        ...
        parameter1.setParamC$03(new ParameterC$DxBand(100.0 / 1000));
        parameter1.setParamC$04(new ParameterC$DxBand(340.00000000000017 / 1000));

        parameter1.setParamD$01(new ParameterD$Macd1(0.6800000000000012 / 1000));
        parameter1.setParamD$02(new ParameterD$Macd2(35.00000000000002 / 1000));
        parameter1.setParamD$03(new ParameterD$Sig(0.37000000000000033 / 1000));
